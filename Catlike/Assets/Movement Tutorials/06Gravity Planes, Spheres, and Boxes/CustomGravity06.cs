...
namespace Movement06
{
    ...
    {
        static List<GravitySource06> sources = new List<GravitySource06>();
        ...
        public static void Register(GravitySource06 source)
        {
            Debug.Assert(!sources.Contains(source), "重复注册引力", source);
            sources.Add(source);
        }

        public static void Unregister(GravitySource06 source)
        {
